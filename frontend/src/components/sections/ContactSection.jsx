        ...
        <div className="contact-grid">
          <div className={`contact-map-wrap glass-card ${visible ? 'visible' : ''}`}>
            <iframe
              ...
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3828.5!2d74.58!3d16.85!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc1191c6f7e5a23%3A0x4b2e8c1d3a5f7890!2sTimber%20Area%2C%20Vishrambag%2C%20Sangli%2C%20Maharashtra!5e0!3m2!1sen!2sin!4v1700000000000"
              width="100%"
              height="100%"
          ...
          <div className="contact-cards">
            <div className={`contact-card glass-card ${visible ? 'visible' : ''}`} style={{ transitionDelay: '100ms' }}>
              ...
              <div>
                ...
                Timber Area, District Sangli,<br />
            ...
            <div className={`contact-card glass-card urgent ${visible ? 'visible' : ''}`} style={{ transitionDelay: '500ms' }}>
              ...
              <div>
                ...
                <p>Timber Area, District Sangli,<br />Maharashtra, India</p>
              </div>
            </div>
          </div>
        </div>
